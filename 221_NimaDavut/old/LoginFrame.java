...
//    }
    ...
    private void next1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_next1ActionPerformed
        ...
        {       
           if(!checkIfS())
            ...
            else if(!(Integer.parseInt(newId.getText())/1000000>=1) || !(Integer.parseInt(newId.getText())/10000000<1))
        JOptionPane.showMessageDialog(jPanel2, "ID MUST BE 8 DIGIT INTEGERS!",
                    "ID TYPE MISSMATCH", HEIGHT);
            else
           {
               ...
               if(UniverseHealthSys.checkId(Integer.parseInt(finalId)))
                        JOptionPane.showMessageDialog(jPanel2, "USER ALREADY EXISTS!"
                                , "EXISTING USER", HEIGHT);
               else{
    ...
    private void next2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_next2ActionPerformed
        ...
        {
        passn = npass.getText();
        JOptionPane.showMessageDialog(jPanel3, "Gifts will be rewarded randomly, starting February 2022",
                    "GIFTS PAGE", HEIGHT);
        this.setVisible(false);
        if(String.valueOf(MC_CMB.getSelectedItem()).equalsIgnoreCase("member"))
        {
