...
public class ClientFrame extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Client - Copy.png"))); // NOI18N
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 0, 590, 440);
        getContentPane().add(jPanel1);
        jPanel1.setBounds(240, 200, 100, 100);
...
public boolean checkFields()
    ...
    private void finishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finishActionPerformed
        ...
        if(gymc.isSelected())
         ...
         if(bdate.getText().isEmpty() || coupon.getText().isEmpty() || 
...
//                         ,HospitalFrame.stat);
        ...
        String doc;
        if(spac1.isSelected() || rehabc.isSelected())
            doc = HospitalFrame.docName;
        else
            doc = "Unassigned";
        
        int whatever;
        if(spac1.isSelected() || rehabc.isSelected())
            whatever = HospitalFrame.stat;
        else
            whatever = -1;
        try {
            //        lfn.goToLogIn();
            UniverseHealthSys.addPerson(Integer.parseInt(lf.getFinalId()),
                    ...
                    Double.parseDouble(bdate.getText()),
                    Integer.parseInt(coupon.getText()), company.getText(),
                    checkDisc(),arrS,doc,whatever ,total);
